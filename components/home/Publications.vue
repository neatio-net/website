      ...
      <v-stack md-direction="column" justify="space-between" align="center">
        ...
        >
          <app-section-descriptor
            title="Neatio Blog"
            heading="Keep up to date with Neatio and our research."
            description="We frequently not only write about updates and partnerships at Neatio but deep dive into research, share insights through ‘Engineering at Neatio and ‘Design at Neatio series, and break down the future of Web 3."
...
export default {
  ...
  methods: {
    openBlog() {
      window.open('https://blog.neatio.net', '_blank')
    },
  },
}
</script>
